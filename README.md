...
1. Create a new repository on GitHub — name it exactly `WeAreTheCreatives.github.io`.
   Keep it **public**.
...
4. Wait 1–2 minutes, then visit `https://WeAreTheCreatives.github.io` — your
   portfolio is live.
...
```bash
git init
git remote add origin https://github.com/WeAreTheCreatives/WeAreTheCreatives.github.io.git
git add .
